...
class StudentDeals extends StatefulWidget {
  const StudentDeals({super.key});

  @override
  _StudentDealsState createState() => _StudentDealsState();
}

class _StudentDealsState extends State<StudentDeals> {
