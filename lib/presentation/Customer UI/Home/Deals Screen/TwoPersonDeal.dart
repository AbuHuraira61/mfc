...
class TwoPersonDeal extends StatefulWidget {
  const TwoPersonDeal({super.key});

  @override
  _TwoPersonDealState createState() => _TwoPersonDealState();
}

class _TwoPersonDealState extends State<TwoPersonDeal> {
...
//     (index) => {
//       "name": "Pizza Deal",
//       "description": "Includes a delicious pizza, garlic bread, and drinks.",
//       "price": "RS 2000.00",
